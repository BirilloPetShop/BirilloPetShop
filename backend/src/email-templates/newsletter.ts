 ...
 * This is a reusable template. Replace placeholders before sending:
 * {{TITLE}} - Newsletter title
 * {{CONTENT}} - Main HTML content
 * {{CTA_TEXT}} - Button text (optional)
 * {{CTA_URL}} - Button URL (optional)
 */
export const newsletterEmailHtml = `
<!DOCTYPE html>
...
<head>
  ...
  <title>Birillo Pet Shop - Newsletter</title>
  <style>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td align="center" style="padding-bottom:24px;">
                    <img src="https://res.cloudinary.com/dayxi0enk/image/upload/v1772037570/email/icon-envelope.svg" alt="" width="64" height="64" style="width:64px; height:64px; display:block;" />
                  </td>
                </tr>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" style="border-radius:50px; background-color:#008F4C; box-shadow:0 4px 14px rgba(0,143,76,0.25);">
                          <a href="{{CTA_URL}}" target="_blank" class="cta-btn" style="display:inline-block; padding:15px 36px; font-size:16px; font-weight:700; color:#ffffff; text-decoration:none; border-radius:50px; letter-spacing:0.3px;">
                            {{CTA_TEXT}} &rarr;
                          </a>
                        </td>
                      </tr>
                ...
                <tr>
                  <td align="center">
                    <p style="margin:0; font-size:12px; color:#a8a29e; line-height:1.5;">
                      Ricevi questa email perche ti sei iscritto alla newsletter di Birillo Pet Shop.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td class="footer-pad" style="background-color:#064e3b; padding:32px 40px; border-radius:0 0 16px 16px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td align="center">
                    <a href="{{UNSUBSCRIBE_URL}}" style="font-size:11px; color:#6ee7b7; text-decoration:underline; opacity:0.7;">
