/**
 * Email template: Iscrizione Newsletter Confermata
 * Nessun placeholder — email di notifica pura (no double opt-in)
 */
export const newsletterConfirmationEmailHtml = `
<!DOCTYPE html>
...
<head>
  ...
  <title>Iscrizione confermata - Birillo Pet Shop</title>
  <style>
    ...
    <tr>
      <td align="center">
        ...
        <table role="presentation" class="outer-table" width="560" cellpadding="0" cellspacing="0" style="max-width:560px; width:100%;">
          ...
          <!-- ACCENT BAR -->
          <tr>
            <td style="background-color:#008F4C; height:4px; font-size:0; line-height:0;">&nbsp;</td>
          </tr>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td align="center" style="padding-bottom:24px;">
                    <img src="https://res.cloudinary.com/dayxi0enk/image/upload/v1772038775/email/icon-heart-mail.svg" alt="" width="64" height="64" style="width:64px; height:64px; display:block;" />
                  </td>
                </tr>
                ...
                <tr>
                  <td align="center" style="padding-bottom:28px;">
                    <p class="subtitle" style="margin:0; font-size:15px; color:#78716c; line-height:1.6; max-width:400px;">
                      Grazie per esserti iscritto alla newsletter di Birillo Pet Shop! Da ora riceverai in anteprima offerte esclusive, consigli utili per i tuoi amici a quattro zampe e tutte le novit&agrave; dal nostro negozio.
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td align="center" style="padding-bottom:28px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="background-color:#f0fdf4; border-radius:12px; padding:20px 24px; border:1px solid #bbf7d0;">
                          <p style="margin:0; font-size:14px; color:#166534; line-height:1.6; text-align:center; font-weight:600;">
                            Cosa aspettarti dalla nostra newsletter:
                          </p>
                          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:12px;">
                            <tr>
                              <td style="padding:4px 0; font-size:14px; color:#15803d; line-height:1.5;">
                                &#10003;&nbsp; Offerte e promozioni esclusive
                              </td>
                            </tr>
                            <tr>
                              <td style="padding:4px 0; font-size:14px; color:#15803d; line-height:1.5;">
                                &#10003;&nbsp; Consigli per la cura dei tuoi animali
                              </td>
                            </tr>
                            <tr>
                              <td style="padding:4px 0; font-size:14px; color:#15803d; line-height:1.5;">
                                &#10003;&nbsp; Novit&agrave; e nuovi arrivi in negozio
                              </td>
                            </tr>
                          </table>
                        </td>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" style="border-radius:50px; background-color:#008F4C; box-shadow:0 4px 14px rgba(0,143,76,0.25);">
                          <a href="{{SITE_URL}}" target="_blank" class="cta-btn" style="display:inline-block; padding:15px 36px; font-size:16px; font-weight:700; color:#ffffff; text-decoration:none; border-radius:50px; letter-spacing:0.3px;">
                            Visita il Negozio &rarr;
                          </a>
                        </td>
                      </tr>
                    </table>
                ...
                <tr>
                  <td align="center">
                    <p style="margin:0; font-size:12px; color:#a8a29e; line-height:1.5;">
                      Se non hai richiesto l'iscrizione alla newsletter, puoi ignorare questa email. Non riceverai altri messaggi.
                    </p>
                  </td>
                </tr>
              </table>
...
export const newsletterConfirmationEmailSubject = 'Benvenuto nella newsletter di Birillo Pet Shop!';
