 ...
 * Variables: <%= URL %>, <%= TOKEN %>, <%= USER.username %>, <%= USER.email %>
 */
...
<head>
  ...
  <title>Reimposta Password - Birillo Pet Shop</title>
  <style>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td align="center" style="padding-bottom:24px;">
                    <img src="https://res.cloudinary.com/dayxi0enk/image/upload/v1772037568/email/icon-lock.svg" alt="" width="64" height="64" style="width:64px; height:64px; display:block;" />
                  </td>
                </tr>
                ...
                <tr>
                  <td align="center" style="padding-bottom:32px;">
                    <p class="subtitle" style="margin:0; font-size:15px; color:#78716c; line-height:1.6; max-width:400px;">
                      Abbiamo ricevuto una richiesta di reimpostazione della password per il tuo account. Clicca il bottone qui sotto per crearne una nuova.
                    </p>
                  </td>
                </tr>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" style="border-radius:50px; background-color:#008F4C; box-shadow:0 4px 14px rgba(0,143,76,0.25);">
                          <a href="<%= URL %>?code=<%= TOKEN %>" target="_blank" class="cta-btn" style="display:inline-block; padding:15px 36px; font-size:16px; font-weight:700; color:#ffffff; text-decoration:none; border-radius:50px; letter-spacing:0.3px;">
                ...
                <tr>
                  <td style="padding-bottom:24px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="background-color:#fef3c7; border:1px solid #fde68a; border-radius:12px; padding:14px 18px;">
                          <p style="margin:0; font-size:13px; color:#92400e; line-height:1.5;">
                            <strong>Nota:</strong> Se non hai richiesto tu questa operazione, puoi ignorare questa email in tutta sicurezza. La tua password non cambiera.
                          </p>
                        </td>
                      </tr>
                    </table>
                ...
                <tr>
                  <td align="center" style="padding-bottom:8px;">
                    <p style="margin:0; font-size:12px; color:#a8a29e; line-height:1.5;">
                      Questo link scadra tra 24 ore. Se il bottone non funziona, copia e incolla questo link:
                    </p>
                  </td>
                </tr>
                <tr>
...
export const resetPasswordEmailSubject = 'Reimposta la tua password - Birillo Pet Shop';
